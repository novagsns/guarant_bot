...
TRADE_BONUS_ANNOUNCEMENT = (
    ...
    "Обмен:\n"
    "• обмен → 400 ₽\n"
    "• обмен с доплатой → 400 ₽ + 8% от доплаты\n"
    "\n"
    "Рассрочка:\n"
    "• 12%\n"
    "────────────────────\n"
    ...
    "\n"
    "🥉 УРОВЕНЬ 1 — 10+ сделок\n"
    "• К/П: скидка −1 п.п. от базовой ставки\n"
    "• обмен: 370 ₽\n"
    "• обмен с доплатой: 370 ₽ + 7% от доплаты\n"
    "🏷 Префикс: «GSNS Trader»\n"
    "\n"
    "🥈 УРОВЕНЬ 2 — 15+ сделок\n"
    "• К/П: скидка −2 п.п. от базовой ставки\n"
    "• обмен: 340 ₽\n"
    "• обмен с доплатой: 340 ₽ + 6% от доплаты\n"
    "• рассрочка: 11%\n"
    "🏷 Префикс: «GSNS PRO»\n"
    "\n"
    "📌 С «GSNS PRO» скидка действует и для покупателя,\n"
    "если у покупателя тоже «GSNS PRO».\n"
    "\n"
    "🥇 УРОВЕНЬ 3 — 25+ сделок\n"
    "• К/П: скидка −3 п.п. от базовой ставки\n"
    "• обмен: 300 ₽\n"
    "• обмен с доплатой: 300 ₽ + 5% от доплаты\n"
    "• рассрочка: 10%\n"
    "🏷 Префикс: «GSNS ELITE»\n"
    "\n"
    "🧾 Ограничения:\n"
    "• скидки применяются к процентным тарифам (фикс 200 ₽ не меняется)\n"
    "• минимальная ставка по К/П — 6%\n"
    "\n"
    "✅ По выдаче префиксов: @gsns_trade_bot"
)
